...
namespace RocketLab\Bundle\Init\Libs;

use RocketLab\Bundle\Init\Helpers\InputHelper;
use RocketLab\Bundle\Init\Tasks\BaseTask;
...
class Init
{
    ...
    public function run()
    {
        ...
        $this->initParams();
        $this->output->write("Yii Application Initialization Tool v1.0\n\n");
